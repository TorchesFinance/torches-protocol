...
import "./Ownable.sol";
import "./EnzoPriceOracle.sol";

contract EnzoAssetOracle is ChainlinkAggregatorV3Interface, Ownable {
    using SafeMath for uint;

    uint8 private decimals_;
    string private description_;
    EnzoPriceOracle public baseOracle;
    ...
    function setBaseOracle(EnzoPriceOracle _baseOracle) external onlyOwner {
        baseOracle = _baseOracle;
    }
}
