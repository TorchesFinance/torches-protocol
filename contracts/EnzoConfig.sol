...
contract EnzoConfig is Ownable, Exponential {
    ...
    constructor(EnzoConfig previousEnzoConfig) public {
        safetyGuardian = msg.sender;
        if (address(previousEnzoConfig) == address(0x0)) return;
       
        safetyGuardian = previousEnzoConfig.safetyGuardian();
        compToken = previousEnzoConfig.compToken();
        safetyVaultRatio = previousEnzoConfig.safetyVaultRatio();
        safetyVault = previousEnzoConfig.safetyVault();
    }
